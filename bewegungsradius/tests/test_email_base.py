...
from bewegungsradius.core.email.exceptions import (
...
class TestBaseEmailService:
    ...
    @patch('bewegungsradius.core.email.base.render_to_string')
    @patch.object(BaseEmailService, '_send_email')
    def test_send_single_email_logs_success(self, mock_send, mock_render, service, caplog):
...
class TestEmailServiceIntegration:
    ...
    @patch('bewegungsradius.core.email.base.render_to_string')
    @patch('bewegungsradius.core.email.base.EmailMultiAlternatives')
    def test_bulk_workflow_with_mixed_results(self, mock_email_class, mock_render, service):
