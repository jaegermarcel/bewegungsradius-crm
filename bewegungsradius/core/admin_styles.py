...
class BadgeStyle:
    ...
    @staticmethod
    def badge(text: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
...
class SimpleText:
    ...
    @staticmethod
    def literal_text(content: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
        """Einfach nur farbiger Text"""
        colors = {
    ...
    @staticmethod
    def bold(content: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
    ...
    @staticmethod
    def icon(content: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = '') -> str:
        ...
        fg = colors.get(color, '')
        return format_html('<span style="color: {}; font-size: 1.2em;">{}</span>', fg, content)

    @staticmethod
    def muted(content: str) -> str:
        """Grauer Text (inaktiv)"""
        return format_html('<span style="color: {};">{}</span>', Colors.SECONDARY, content)
...
class StatusIndicator:
    ...
    @staticmethod
    def yes_no_simple(value: bool, yes_label: str = 'Ja', no_label: str = 'Nein') -> str:
    ...
    def email_status_icon_only(was_sent: bool) -> str:
        """Email - nur Icon"""
        return SimpleText.icon('✓' if was_sent else '✗', 'success' if was_sent else 'error')
...
class DisplayHelpers:
    ...
    @staticmethod
    def colored_text(text: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
        """Text mit Farbe ohne Badge"""
        return SimpleText.literal_text(text, color)

    @staticmethod
    def colored_bold(text: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
    ...
    def muted_text_two_line(text_line1: str, text_line2: str = '') -> list:
        return [
            format_html('<span style="color: {};">{}</span>', Colors.SECONDARY, text_line1),
            format_html('<span style="color: {}; font-size: 0.9em;">{}</span>', Colors.SECONDARY, text_line2),
        ]
    ...
    @staticmethod
    def highlight_box(content: str, color: Literal['success', 'warning', 'error', 'info'] = 'info') -> str:
        """Box mit Hintergrund"""
        colors = {
            'success': (Colors.BG_SUCCESS, Colors.TEXT_SUCCESS),
            'warning': (Colors.BG_WARNING, Colors.TEXT_WARNING),
    ...
    @staticmethod
    def link(text: str, href: str, color: Literal['success', 'warning', 'error', 'info', 'secondary'] = 'info') -> str:
        """Link mit Farbe"""
        colors = {
            'success': Colors.SUCCESS,
            'warning': Colors.WARNING,
