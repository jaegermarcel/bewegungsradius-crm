...
class Location(models.Model):
    ...
    max_participants = models.PositiveIntegerField(default=10, verbose_name="Max. Teilnehmer (Präsenz)")
...
class Course(models.Model):
    ...
    offer = models.ForeignKey(Offer, on_delete=models.PROTECT, related_name='courses', verbose_name="Angebot")
    ...
    is_weekly = models.BooleanField(default=True, verbose_name="Wöchentlich wiederkehrend")
    ...
    location = models.ForeignKey(Location, on_delete=models.SET_NULL, null=True, blank=True, related_name='courses',
                                 verbose_name="Kursort")
    ...
    def email_status_display(self):
        ...
        if self.completion_email_sent:
            status.append(f"Abschluss: ✓ ({self.completion_email_sent_at.strftime('%d.%m.%Y')})")
        else:
