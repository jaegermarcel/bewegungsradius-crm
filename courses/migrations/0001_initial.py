    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Standort-Name"),
                ),
                (
                    "street",
                ...
                (
                    "house_number",
                    models.CharField(
                        blank=True, max_length=10, verbose_name="Hausnummer"
                    ),
                ),
                (
                    "postal_code",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=100,
                        verbose_name="Special (z.B. Winter Special)",
                    ),
                ),
                ...
                (
                    "price",
                    models.DecimalField(
                        decimal_places=2, max_digits=8, verbose_name="Preis"
                    ),
                ),
                (
                    "created_at",
