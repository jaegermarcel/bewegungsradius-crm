...
class InvoiceAdmin(SimpleHistoryAdmin, ImportExportModelAdmin, ModelAdmin):
    ...
    def total_amount_display_readonly(self, obj):
        ...
        return format_html('<strong style="color: {};">{} €</strong>', Colors.TEXT_SUCCESS, amount_str)
    ...
    def has_send_invoice_email_permission(self, request: HttpRequest, object_id: Union[str, int]):
    ...
    def has_mark_as_sent_permission(self, request: HttpRequest, object_id: Union[str, int]):
        return request.user.has_perm('invoices.change_invoice')
    ...
    def has_mark_as_paid_permission(self, request: HttpRequest, object_id: Union[str, int]):
        return request.user.has_perm('invoices.change_invoice')
    ...
    def has_stornieren_permission(self, request: HttpRequest, object_id: Union[str, int]):
    ...
    def has_download_invoice_pdf_permission(self, request: HttpRequest, object_id: Union[str, int]):
    ...
    def has_download_storno_pdf_permission(self, request: HttpRequest, object_id: Union[str, int]):
        return InvoicePDFDownloadHandler.has_download_storno_pdf_permission(object_id, request)
    ...
    def bulk_mark_as_sent(self, request, queryset):
        ...
        self.message_user(request, f'✅ {count} Rechnung(en) wurden als versendet markiert.')
