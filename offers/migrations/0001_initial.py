        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "offer_number",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Angebotsnummer"
                    ),
                ),
                (
                    "course_type",
                ...
                (
                    "course_units",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Anzahl Einheiten"
                    ),
                ),
                (
                    "course_duration",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Dauer pro Einheit"
                    ),
                ),
                (
                    "amount",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="Zertifiziert nach § 20 SGBV"
                    ),
                ),
                (
                    "zpp_prevention_id",
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("KU-BE-SC4KUQ", "Body-Wrkout Präsens 2027"),
                        ],
                        max_length=50,
                ...
                (
                    "notes",
                    models.TextField(blank=True, verbose_name="Notizen/Besonderheiten"),
                ),
                (
                    "created_at",
